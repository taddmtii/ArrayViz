...
var grammar = {
    ...
    {"name": "or_expression", "symbols": ["or_expression", (lexer.has("OR") ? {type: "OR"} : OR), "and_expression"], "postprocess": d => (new BinaryExpressionNode(new ExpressionNode(d[0], d[1], new BinaryExpressionNode(d[2]))))},
    {"name": "or_expression", "symbols": ["and_expression"], "postprocess": id},
    {"name": "and_expression", "symbols": ["and_expression", (lexer.has("AND") ? {type: "AND"} : AND), "not_expression"], "postprocess": d => (new BinaryExpressionNode(new ExpressionNode(d[0], d[1], new BinaryExpressionNode(d[2]))))},
    ...
    {"name": "comparison_expression", "symbols": ["additive", "comparison_expression$subexpression$1", "additive"], "postprocess": d => (new ComparisonExpressionNode(new ExpressionNode(d[0]), d[1].value, new ExpressionNode(d[2])))},
    ...
    {"name": "additive", "symbols": ["additive", "additive$subexpression$1", "multiplicative"], "postprocess": d => (new BinaryExpressionNode(new ExpressionNode(d[0], d[1].value, new BinaryExpressionNode(d[2]))))},
    ...
    {"name": "multiplicative", "symbols": ["multiplicative", "multiplicative$subexpression$1", "unary"], "postprocess": d => (new BinaryExpressionNode(new ExpressionNode(d[0], d[1].value, new BinaryExpressionNode(d[2]))))},
    ...
    {"name": "power", "symbols": ["primary", (lexer.has("POWER") ? {type: "POWER"} : POWER), "unary"], "postprocess": d => (new BinaryExpressionNode(new ExpressionNode(d[0], d[1].value, new BinaryExpressionNode(d[2]))))},
