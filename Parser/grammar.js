...
var grammar = {
    Lexer: lexer,
    ParserRules: [
    {"name": "program", "symbols": ["statement_list"], "postprocess": d => d[0]},
    ...
    {"name": "simple_statement", "symbols": ["assignment_statement"], "postprocess": d => d[0]},
    {"name": "simple_statement", "symbols": ["return_statement"], "postprocess": d => d[0]},
    ...
    {"name": "simple_statement", "symbols": ["expression"], "postprocess": d => (new ExpressionStatementNode(d[0], d[0]._tok))},
    {"name": "compound_statement", "symbols": ["if_statement"], "postprocess": d => d[0]},
    {"name": "compound_statement", "symbols": ["for_loop"], "postprocess": d => d[0]},
    {"name": "compound_statement", "symbols": ["while_loop"], "postprocess": d => d[0]},
    {"name": "compound_statement", "symbols": ["func_def"], "postprocess": d => d[0]},
    {"name": "assignment_statement", "symbols": [(lexer.has("IDENTIFIER") ? {type: "IDENTIFIER"} : IDENTIFIER), (lexer.has("ASSIGNMENT") ? {type: "ASSIGNMENT"} : ASSIGNMENT), "expression"], "postprocess": d => (new AssignmentStatementNode(d[0].text, d[2], d[0]))},
    {"name": "assignment_statement", "symbols": ["list_access", (lexer.has("ASSIGNMENT") ? {type: "ASSIGNMENT"} : ASSIGNMENT), "expression"], "postprocess": d => (new AssignmentStatementNode(d[0], d[2], d[0]._tok))},
    ...
    {"name": "if_statement", "symbols": [(lexer.has("IF") ? {type: "IF"} : IF), "expression", (lexer.has("COLON") ? {type: "COLON"} : COLON), "block", "if_statement$ebnf$1"], "postprocess": d => (new IfStatementNode(d[1], d[3], d[4] ? d[4][0] : null, d[0]))},
    ...
    {"name": "formal_params_list", "symbols": [(lexer.has("IDENTIFIER") ? {type: "IDENTIFIER"} : IDENTIFIER), "formal_params_list$ebnf$1"], "postprocess": d => new FormalParamsListExpressionNode([new IdentifierExpressionNode(d[0]), ...d[1].map(x => new IdentifierExpressionNode(x[1]))])},
    ...
    {"name": "arg_list", "symbols": ["expression", "arg_list$ebnf$1"], "postprocess": d => new ArgListExpressionNode([d[0], ...d[1].map(x => x[1])])},
    ...
    {"name": "block", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL), (lexer.has("INDENT") ? {type: "INDENT"} : INDENT), "block$ebnf$1", (lexer.has("DEDENT") ? {type: "DEDENT"} : DEDENT)], "postprocess": d => (new BlockStatementNode(d[2], d[1]))},
    ...
    {"name": "conditional_expression", "symbols": ["or_expression", (lexer.has("IF") ? {type: "IF"} : IF), "or_expression", (lexer.has("ELSE") ? {type: "ELSE"} : ELSE), "conditional_expression"], "postprocess": d => (new ConditionalExpressionNode(d[0], d[2], d[4]))},
    {"name": "conditional_expression", "symbols": ["or_expression"], "postprocess": d => d[0]},
    {"name": "or_expression", "symbols": ["or_expression", (lexer.has("OR") ? {type: "OR"} : OR), "and_expression"], "postprocess": d => (new BinaryExpressionNode(d[0], d[1].value, d[2], d[1]))},
    {"name": "or_expression", "symbols": ["and_expression"], "postprocess": d => d[0]},
    {"name": "and_expression", "symbols": ["and_expression", (lexer.has("AND") ? {type: "AND"} : AND), "not_expression"], "postprocess": d => (new BinaryExpressionNode(d[0], d[1].value, d[2], d[1]))},
    {"name": "and_expression", "symbols": ["not_expression"], "postprocess": d => d[0]},
    {"name": "not_expression", "symbols": [(lexer.has("NOT") ? {type: "NOT"} : NOT), "not_expression"], "postprocess": d => (new UnaryExpressionNode(d[0].value, d[1], d[0]))},
    {"name": "not_expression", "symbols": ["comparison_expression"], "postprocess": d => d[0]},
    ...
    {"name": "additive", "symbols": ["additive", "additive$subexpression$1", "multiplicative"], "postprocess": d => (new BinaryExpressionNode(d[0], d[1][0].value, d[2], d[1][0]))},
    ...
    {"name": "multiplicative", "symbols": ["multiplicative", "multiplicative$subexpression$1", "unary"], "postprocess": d => (new BinaryExpressionNode(d[0], d[1][0].value, d[2], d[1][0]))},
    ...
    {"name": "unary", "symbols": ["unary$subexpression$1", "unary"], "postprocess": d => (new UnaryExpressionNode(d[0][0].value, d[1], d[0][0]))},
    {"name": "unary", "symbols": ["power"], "postprocess": d => d[0]},
    {"name": "power", "symbols": ["primary", (lexer.has("POWER") ? {type: "POWER"} : POWER), "unary"], "postprocess": d => (new BinaryExpressionNode(d[0], d[1].value, d[2], d[1]))},
    ...
    {"name": "function_call", "symbols": ["primary", (lexer.has("LPAREN") ? {type: "LPAREN"} : LPAREN), "function_call$ebnf$1", (lexer.has("RPAREN") ? {type: "RPAREN"} : RPAREN)], "postprocess": d => (new FuncCallExpressionNode(d[0], d[2] || null))},
    {"name": "list_access", "symbols": ["primary", (lexer.has("LSQBRACK") ? {type: "LSQBRACK"} : LSQBRACK), "expression", (lexer.has("RSQBRACK") ? {type: "RSQBRACK"} : RSQBRACK)], "postprocess": d => (new ListAccessExpressionNode(d[0], d[2]))},
    ...
    {"name": "list_slice", "symbols": ["primary", (lexer.has("LSQBRACK") ? {type: "LSQBRACK"} : LSQBRACK), (lexer.has("COLON") ? {type: "COLON"} : COLON), "expression", (lexer.has("RSQBRACK") ? {type: "RSQBRACK"} : RSQBRACK)], "postprocess": d => new ListSliceExpressionNode(d[0], null, d[3], null)},
    {"name": "list_slice", "symbols": ["primary", (lexer.has("LSQBRACK") ? {type: "LSQBRACK"} : LSQBRACK), "expression", (lexer.has("COLON") ? {type: "COLON"} : COLON), (lexer.has("RSQBRACK") ? {type: "RSQBRACK"} : RSQBRACK)], "postprocess": d => new ListSliceExpressionNode(d[0], d[2], null, null)},
    {"name": "list_slice$ebnf$1", "symbols": [(lexer.has("COLON") ? {type: "COLON"} : COLON)], "postprocess": id},
    {"name": "list_slice$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "list_slice", "symbols": ["primary", (lexer.has("LSQBRACK") ? {type: "LSQBRACK"} : LSQBRACK), (lexer.has("COLON") ? {type: "COLON"} : COLON), "list_slice$ebnf$1", (lexer.has("RSQBRACK") ? {type: "RSQBRACK"} : RSQBRACK)], "postprocess": d => new ListSliceExpressionNode(d[0], null, null, null)},
    {"name": "atom", "symbols": ["number"], "postprocess": d => d[0]},
    {"name": "atom", "symbols": [(lexer.has("STRING_SINGLE") ? {type: "STRING_SINGLE"} : STRING_SINGLE)], "postprocess": d => (new StringLiteralExpressionNode(d[0]))},
    {"name": "atom", "symbols": [(lexer.has("STRING_DOUBLE") ? {type: "STRING_DOUBLE"} : STRING_DOUBLE)], "postprocess": d => (new StringLiteralExpressionNode(d[0]))},
    {"name": "atom", "symbols": [(lexer.has("IDENTIFIER") ? {type: "IDENTIFIER"} : IDENTIFIER)], "postprocess": d => (new IdentifierExpressionNode(d[0]))},
    {"name": "atom", "symbols": ["list_literal"], "postprocess": d => d[0]},
    {"name": "atom", "symbols": [(lexer.has("NONE") ? {type: "NONE"} : NONE)], "postprocess": d => null},
    {"name": "atom", "symbols": [(lexer.has("TRUE") ? {type: "TRUE"} : TRUE)], "postprocess": d => (new BooleanLiteralExpressionNode(true, d[0]))},
    {"name": "atom", "symbols": [(lexer.has("FALSE") ? {type: "FALSE"} : FALSE)], "postprocess": d => (new BooleanLiteralExpressionNode(false, d[0]))},
    {"name": "atom", "symbols": ["group"], "postprocess": d => d[0]},
    {"name": "number", "symbols": [(lexer.has("HEX") ? {type: "HEX"} : HEX)], "postprocess": d => (new NumberLiteralExpressionNode(d[0].value, d[0]))},
    {"name": "number", "symbols": [(lexer.has("BINARY") ? {type: "BINARY"} : BINARY)], "postprocess": d => (new NumberLiteralExpressionNode(d[0].value, d[0]))},
    {"name": "number", "symbols": [(lexer.has("DECIMAL") ? {type: "DECIMAL"} : DECIMAL)], "postprocess": d => (new NumberLiteralExpressionNode(d[0].value, d[0]))},
    {"name": "number", "symbols": [(lexer.has("FLOAT") ? {type: "FLOAT"} : FLOAT)], "postprocess": d => (new NumberLiteralExpressionNode(d[0].value, d[0]))},
