...
var grammar = {
    ...
    {"name": "assignment_statement", "symbols": ["list_access", (lexer.has("ASSIGNMENT") ? {type: "ASSIGNMENT"} : ASSIGNMENT), "expression"], "postprocess": d => (new AssignmentStatementNode(d[0], d[2], d[0]))},
    ...
    {"name": "comparison_expression", "symbols": ["additive", "comparison_expression$subexpression$1", "additive"], "postprocess": d => (new ComparisonExpressionNode(d[0], d[1], d[2], d[1]))},
    ...
    {"name": "additive", "symbols": ["additive", "additive$subexpression$1", "multiplicative"], "postprocess": d => (new BinaryExpressionNode(d[0], d[1][0].value, d[2], d[1]))},
    ...
    {"name": "multiplicative", "symbols": ["multiplicative", "multiplicative$subexpression$1", "unary"], "postprocess": d => (new BinaryExpressionNode(d[0], d[1][0].value, d[2], d[1]))},
    ...
    {"name": "unary", "symbols": ["unary$subexpression$1", "unary"], "postprocess": d => (new UnaryExpressionNode(d[0], d[1][0].value, d[0]))},
    ...
    {"name": "atom", "symbols": [(lexer.has("TRUE") ? {type: "TRUE"} : TRUE)], "postprocess": d => (new BooleanLiteralExpressionNode(d[0]))},
    {"name": "atom", "symbols": [(lexer.has("FALSE") ? {type: "FALSE"} : FALSE)], "postprocess": d => (new BooleanLiteralExpressionNode(d[0]))},
    {"name": "atom", "symbols": ["group"], "postprocess": id},
    {"name": "number", "symbols": [(lexer.has("HEX") ? {type: "HEX"} : HEX)], "postprocess": d => (new NumberLiteralExpressionNode(d[0]))},
    {"name": "number", "symbols": [(lexer.has("BINARY") ? {type: "BINARY"} : BINARY)], "postprocess": d => (new NumberLiteralExpressionNode(d[0]))},
    {"name": "number", "symbols": [(lexer.has("DECIMAL") ? {type: "DECIMAL"} : DECIMAL)], "postprocess": d => (new NumberLiteralExpressionNode(d[0]))},
