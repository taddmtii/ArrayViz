...
var grammar = {
    ...
    {"name": "statement_list", "symbols": ["statement_list$ebnf$1"], "postprocess": d => (new ProgramNode(d[0]))},
    ...
    {"name": "assignment_statement", "symbols": ["assignment_statement$subexpression$1", (lexer.has("ASSIGNMENT") ? {type: "ASSIGNMENT"} : ASSIGNMENT), "expression"], "postprocess": d => (new AssignmentStatementNode(d[0], d[2]))},
    ...
    {"name": "formal_params_list", "symbols": [(lexer.has("IDENTIFIER") ? {type: "IDENTIFIER"} : IDENTIFIER), "formal_params_list$ebnf$1"], "postprocess": d => [d[0], ...(d[1] ? d[1].map(x => x[1]) : [])]},
    ...
    {"name": "list_access", "symbols": ["primary", (lexer.has("LSQBRACK") ? {type: "LSQBRACK"} : LSQBRACK), "expression", (lexer.has("RSQBRACK") ? {type: "RSQBRACK"} : RSQBRACK)], "postprocess": d => ({ type: "list_access", list: d[0], index: d[2] })},
    ...
    {"name": "atom", "symbols": ["number"], "postprocess": d => (new NumberLiteralExpressionNode(d[0]))},
    {"name": "atom", "symbols": [(lexer.has("STRING_SINGLE") ? {type: "STRING_SINGLE"} : STRING_SINGLE)], "postprocess": d => ({ type: "string_single", content: d[0].value})},
    {"name": "atom", "symbols": [(lexer.has("STRING_DOUBLE") ? {type: "STRING_DOUBLE"} : STRING_DOUBLE)], "postprocess": d => ({ type: "string_double", content: d[0].value})},
