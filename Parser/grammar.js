...
var grammar = {
    ...
    {"name": "additive", "symbols": ["additive", "additive$subexpression$1", "multiplicative"], "postprocess": d => (new BinaryExpressionNode(d[0], d[1], d[2], d[1]))},
    ...
    {"name": "multiplicative", "symbols": ["multiplicative", "multiplicative$subexpression$1", "unary"], "postprocess": d => (new BinaryExpressionNode(d[0], d[1], d[2], d[1]))},
    ...
    {"name": "unary", "symbols": ["unary$subexpression$1", "unary"], "postprocess": d => (new UnaryExpressionNode(d[0], d[1], d[0]))},
    {"name": "unary", "symbols": ["power"]},
    {"name": "power", "symbols": ["primary", (lexer.has("POWER") ? {type: "POWER"} : POWER), "unary"], "postprocess": d => (new BinaryExpressionNode(d[0], d[1], d[2], d[1]))},
