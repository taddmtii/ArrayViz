...
var grammar = {
    ...
    {"name": "unary", "symbols": ["unary$subexpression$1", "unary"], "postprocess": d => (new UnaryExpressionNode(d[0], new ExpressionNode(d[1])))},
    ...
    {"name": "list_slice", "symbols": ["primary", (lexer.has("LSQBRACK") ? {type: "LSQBRACK"} : LSQBRACK), "expression", (lexer.has("COLON") ? {type: "COLON"} : COLON), "expression", (lexer.has("COLON") ? {type: "COLON"} : COLON), "expression", (lexer.has("RSQBRACK") ? {type: "RSQBRACK"} : RSQBRACK)], "postprocess": d => new ListSliceExpressionNode(new ExpressionNode(d[0]), new ExpressionNode(d[2]), new ExpressionNode(d[4]), new ExpressionNode(d[6]))},
    {"name": "list_slice", "symbols": ["primary", (lexer.has("LSQBRACK") ? {type: "LSQBRACK"} : LSQBRACK), "expression", (lexer.has("COLON") ? {type: "COLON"} : COLON), "expression", (lexer.has("RSQBRACK") ? {type: "RSQBRACK"} : RSQBRACK)], "postprocess": d => new ListSliceExpressionNode(new ExpressionNode(d[0]), new ExpressionNode(d[2]), new ExpressionNode(d[4]), null)},
    {"name": "list_slice", "symbols": ["primary", (lexer.has("LSQBRACK") ? {type: "LSQBRACK"} : LSQBRACK), (lexer.has("COLON") ? {type: "COLON"} : COLON), "expression", (lexer.has("COLON") ? {type: "COLON"} : COLON), "expression", (lexer.has("RSQBRACK") ? {type: "RSQBRACK"} : RSQBRACK)], "postprocess": d => new ListSliceExpressionNode(new ExpressionNode(d[0]), null, new ExpressionNode(d[3]), new ExpressionNode(d[5]))},
    {"name": "list_slice", "symbols": ["primary", (lexer.has("LSQBRACK") ? {type: "LSQBRACK"} : LSQBRACK), (lexer.has("COLON") ? {type: "COLON"} : COLON), "expression", (lexer.has("RSQBRACK") ? {type: "RSQBRACK"} : RSQBRACK)], "postprocess": d => new ListSliceExpressionNode(new ExpressionNode(d[0]), null, new ExpressionNode(d[3]), null)},
    {"name": "list_slice", "symbols": ["primary", (lexer.has("LSQBRACK") ? {type: "LSQBRACK"} : LSQBRACK), "expression", (lexer.has("COLON") ? {type: "COLON"} : COLON), (lexer.has("RSQBRACK") ? {type: "RSQBRACK"} : RSQBRACK)], "postprocess": d => new ListSliceExpressionNode(new ExpressionNode(d[0]), new ExpressionNode(d[2]), null, null)},
    ...
    {"name": "list_slice", "symbols": ["primary", (lexer.has("LSQBRACK") ? {type: "LSQBRACK"} : LSQBRACK), (lexer.has("COLON") ? {type: "COLON"} : COLON), "list_slice$ebnf$1", (lexer.has("RSQBRACK") ? {type: "RSQBRACK"} : RSQBRACK)], "postprocess": d => new ListSliceExpressionNode(new ExpressionNode(d[0]), null, null, null)},
