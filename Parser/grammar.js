...
var grammar = {
    ...
    ParserRules: [
        ...
        },
        {
            name: "simple_statement",
            symbols: ["expression"],
            postprocess: (d) => new ExpressionStatementNode(d[0], d[0]._tok),
        },
        {
        ...
        },
        {
            ...
            postprocess: (d) =>
                new MultiAssignmentStatementNode(d[0], d[2], d[1]),
        },
        {
            name: "assignment_statement",
            symbols: [
        ...
        },
        {
            ...
            postprocess: (d) =>
                new AssignmentStatementNode(d[0], d[2], d[0]._tok),
        },
        {
            name: "assignable_list$ebnf$1$subexpression$1",
            symbols: [
        ...
        {
            name: "assignable_list$ebnf$1",
            symbols: ["assignable_list$ebnf$1$subexpression$1"],
        },
        {
            name: "assignable_list$ebnf$1$subexpression$2",
            symbols: [
                lexer.has("COMMA") ? { type: "COMMA" } : COMMA,
                "assignable",
            ],
        },
        {
            name: "assignable_list$ebnf$1",
            symbols: [
                "assignable_list$ebnf$1",
                "assignable_list$ebnf$1$subexpression$2",
            ],
            postprocess: function arrpush(d) {
                return d[0].concat([d[1]]);
            },
        ...
        {
            name: "assignable_list",
            symbols: ["assignable", "assignable_list$ebnf$1"],
            postprocess: (d) => [d[0], ...d[1].map((x) => x[1])],
        },
        {
            name: "assignable",
            symbols: [
        ...
        {
            name: "expression_list$ebnf$1$subexpression$1",
            symbols: [
                lexer.has("COMMA") ? { type: "COMMA" } : COMMA,
                "expression",
            ],
        ...
        {
            name: "expression_list$ebnf$1",
            symbols: ["expression_list$ebnf$1$subexpression$1"],
        },
        {
            name: "expression_list$ebnf$1$subexpression$2",
            symbols: [
                lexer.has("COMMA") ? { type: "COMMA" } : COMMA,
                "expression",
            ],
        },
        {
            name: "expression_list$ebnf$1",
            symbols: [
                "expression_list$ebnf$1",
                "expression_list$ebnf$1$subexpression$2",
            ],
            postprocess: function arrpush(d) {
                return d[0].concat([d[1]]);
            },
        },
        {
            ...
            symbols: ["expression", "expression_list$ebnf$1"],
            postprocess: (d) => [d[0], ...d[1].map((x) => x[1])],
        },
        {
        ...
        },
        {
            ...
            symbols: [
                "multiplicative",
                "multiplicative$subexpression$1",
                "unary",
            ],
            postprocess: (d) =>
                new BinaryExpressionNode(d[0], d[1][0].value, d[2], d[1][0]),
        ...
        },
        {
            ...
            postprocess: (d) =>
                new UnaryExpressionNode(d[0][0].value, d[1], d[0][0]),
        },
        ...
        },
        {
            ...
            postprocess: (d) =>
                new ListSliceExpressionNode(d[0], d[2], d[4], d[6]),
        },
        {
            name: "list_slice",
            symbols: [
            ...
            postprocess: (d) =>
                new ListSliceExpressionNode(d[0], d[2], d[4], null),
        },
        {
            name: "list_slice",
            symbols: [
            ...
            postprocess: (d) =>
                new ListSliceExpressionNode(d[0], null, d[3], d[5]),
        },
        {
            name: "list_slice",
            symbols: [
            ...
            postprocess: (d) =>
                new ListSliceExpressionNode(d[0], null, d[3], null),
        },
        {
            name: "list_slice",
            symbols: [
            ...
            postprocess: (d) =>
                new ListSliceExpressionNode(d[0], d[2], null, null),
        },
        {
            name: "list_slice",
            symbols: [
            ...
            postprocess: (d) =>
                new ListSliceExpressionNode(d[0], null, null, d[4]),
        },
        {
        ...
        },
        {
            ...
            postprocess: (d) =>
                new ListSliceExpressionNode(d[0], null, null, null),
        },
        ...
        { name: "atom", symbols: ["group"], postprocess: (d) => d[0] },
        {
            ...
            postprocess: (d) =>
                new NumberLiteralExpressionNode(d[0].value, d[0]),
        },
        {
            name: "number",
        ...
        },
        {
            ...
            postprocess: (d) =>
                new ListLiteralExpressionNode(d[1] || null, d[0]),
        },
        {
            name: "group",
            symbols: [
