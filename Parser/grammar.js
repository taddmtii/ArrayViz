...
var grammar = {
    ...
    {"name": "formal_params_list", "symbols": [(lexer.has("IDENTIFIER") ? {type: "IDENTIFIER"} : IDENTIFIER), "formal_params_list$ebnf$1"], "postprocess": d => new FormalParamsListExpressionNode(new IdentifierExpressionNode(d[0]), ...(d[1] ? d[1].map(x => new IdentifierExpressionNode(x[1])) : []))},
    ...
    {"name": "list_slice", "symbols": ["primary", (lexer.has("LSQBRACK") ? {type: "LSQBRACK"} : LSQBRACK), (lexer.has("COLON") ? {type: "COLON"} : COLON), (lexer.has("RSQBRACK") ? {type: "RSQBRACK"} : RSQBRACK)], "postprocess": d => new ListSliceExpressionNode(new ExpressionNode(d[0]), null, null, null)},
