...
var grammar = {
    ...
    {"name": "list_method_call$subexpression$1", "symbols": [(lexer.has("IDENTIFIER") ? {type: "IDENTIFIER"} : IDENTIFIER)]},
    {"name": "list_method_call$subexpression$1", "symbols": ["number"]},
    {"name": "list_method_call", "symbols": [(lexer.has("IDENTIFIER") ? {type: "IDENTIFIER"} : IDENTIFIER), (lexer.has("DOT") ? {type: "DOT"} : DOT), "list_method", (lexer.has("LPAREN") ? {type: "LPAREN"} : LPAREN), "list_method_call$subexpression$1", (lexer.has("RPAREN") ? {type: "RPAREN"} : RPAREN)], "postprocess": d => ({type: "append_method_call", list: d[0], type: d[2], value: d[4]})},
