...
var grammar = {
    ...
    {"name": "or_expression", "symbols": ["and_expression", "or_expression$ebnf$1"], "postprocess": d => ({ type: "or_expression", left: d[0], right: [...(d[1] ? d[1].map(x => x[1]) : [])] })},
    ...
    {"name": "and_expression", "symbols": ["not_expression", "and_expression$ebnf$1"], "postprocess": d => ({ type: "and_expression", left: d[0], right: [...(d[1] ? d[1].map(x => x[1]) : [])] })},
    ...
    {"name": "comparison", "symbols": ["additive", "comparison$ebnf$1"], "postprocess": d => ({ type: "comparison_expression", left: d[0], operator: d[1], right: d[2] })},
    {"name": "additive", "symbols": ["additive", (lexer.has("PLUS") ? {type: "PLUS"} : PLUS), "multiplicative"], "postprocess": d => ({type: "additive", left: d[0], operator: d[1], right: d[2]})},
    {"name": "additive", "symbols": ["additive", (lexer.has("MINUS") ? {type: "MINUS"} : MINUS), "multiplicative"], "postprocess": d => ({type: "", left: d[0], operator: d[1], right: d[2]})},
    {"name": "additive", "symbols": ["multiplicative"]},
    {"name": "multiplicative", "symbols": ["multiplicative", (lexer.has("MULT") ? {type: "MULT"} : MULT), "unary"], "postprocess": d => ({type: "multiplicative", left: d[0], operator: d[1], right: d[2]})},
    {"name": "multiplicative", "symbols": ["multiplicative", (lexer.has("INTDIV") ? {type: "INTDIV"} : INTDIV), "unary"], "postprocess": d => ({type: "multiplicative", left: d[0], operator: d[1], right: d[2]})},
    {"name": "multiplicative", "symbols": ["multiplicative", (lexer.has("DIV") ? {type: "DIV"} : DIV), "unary"], "postprocess": d => ({type: "multiplicative", left: d[0], operator: d[1], right: d[2]})},
    {"name": "multiplicative", "symbols": ["multiplicative", (lexer.has("MOD") ? {type: "MOD"} : MOD), "unary"], "postprocess": d => ({type: "multiplicative", left: d[0], operator: d[1], right: d[2]})},
    {"name": "multiplicative", "symbols": ["unary"]},
    {"name": "unary", "symbols": [(lexer.has("PLUS") ? {type: "PLUS"} : PLUS), "unary"], "postprocess": d => ({type: "unary", operator: d[0], number: d[1]})},
    {"name": "unary", "symbols": [(lexer.has("MINUS") ? {type: "MINUS"} : MINUS), "unary"], "postprocess": d => ({type: "unary", operator: d[0], number: d[1]})},
    ...
    {"name": "primary", "symbols": [(lexer.has("LPAREN") ? {type: "LPAREN"} : LPAREN), "expression", (lexer.has("RPAREN") ? {type: "RPAREN"} : RPAREN)], "postprocess": d => ({type: "grouped_expression", expression: d[1]})},
    ...
    {"name": "assignment_statement", "symbols": ["assignment_statement$subexpression$1", (lexer.has("EQ") ? {type: "EQ"} : EQ), "expression"], "postprocess": d => ({ type: "assignment_statement", var: d[0], value: d[2] })},
