...
var grammar = {
    ...
    {"name": "statement_list$ebnf$1", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)]},
    {"name": "statement_list$ebnf$1", "symbols": ["statement_list$ebnf$1", (lexer.has("NL") ? {type: "NL"} : NL)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "statement_list", "symbols": ["statement", "statement_list$ebnf$1"], "postprocess": d => ({ type: "statement_list", statements: [d[0]]})},
    {"name": "statement_list$ebnf$2", "symbols": [(lexer.has("NL") ? {type: "NL"} : NL)]},
    {"name": "statement_list$ebnf$2", "symbols": ["statement_list$ebnf$2", (lexer.has("NL") ? {type: "NL"} : NL)], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "statement_list", "symbols": ["statement", "statement_list$ebnf$2", "statement_list"], "postprocess": d => ({ type: "statement_list", statements: [d[0], ...d[2].statements]})},
    ...
    {"name": "statement", "symbols": [(lexer.has("BREAK") ? {type: "BREAK"} : BREAK)], "postprocess": d => ({ type: "break_statement"})},
    {"name": "statement", "symbols": [(lexer.has("CONTINUE") ? {type: "CONTINUE"} : CONTINUE)], "postprocess": d => ({ type: "continue_statement"})},
    {"name": "statement", "symbols": [(lexer.has("PASS") ? {type: "PASS"} : PASS)], "postprocess": d => ({ type: "pass_statement"})},
    {"name": "statement", "symbols": ["expression"], "postprocess": d => ({ type: "expression_statement", expr: d[0]})},
    ...
    {"name": "multiplicative", "symbols": ["multiplicative", "multiplicative$subexpression$1", "power"], "postprocess": d => ({type: "multiplicative", left: d[0], operator: d[1], right: d[2]})},
    {"name": "multiplicative", "symbols": ["power"], "postprocess": id},
    {"name": "power", "symbols": ["primary", (lexer.has("POWER") ? {type: "POWER"} : POWER), "multiplicative"], "postprocess": d => ({type: "power", left: d[0], right: d[2]})},
    ...
    {"name": "array_access", "symbols": ["expression", (lexer.has("LSQBRACK") ? {type: "LSQBRACK"} : LSQBRACK), "expression", (lexer.has("RSQBRACK") ? {type: "RSQBRACK"} : RSQBRACK)], "postprocess": d => ({ type: "array_access", array: d[0], index: d[2] })},
    ...
    {"name": "list_slice", "symbols": ["expression", (lexer.has("LSQBRACK") ? {type: "LSQBRACK"} : LSQBRACK), "list_slice$ebnf$1", (lexer.has("COLON") ? {type: "COLON"} : COLON), "list_slice$ebnf$2", "list_slice$ebnf$3", (lexer.has("RSQBRACK") ? {type: "RSQBRACK"} : RSQBRACK)], "postprocess": d => ({type: "list_slice", list: d[0], start: d[2], stop: d[4], step: d[6]})},
