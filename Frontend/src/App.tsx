...
function App() {
    ...
    function handleRun() {
        ...
        if (!success) {
            const parseError =
                interpreterServiceReference.current.getParseError();
            setInterpreterState({
                ...interpreterState,
    ...
    function handlePageChange(newPage: "view" | "predict") {
        setPage(newPage);
        handleReset();
        interpreterServiceReference.current.setPredictMode(
            newPage === "predict",
        );
    }
                ...
                <div className="flex flex-col w-[60vw] h-[80vh] gap-2">
                    <CodeWindow
                        ...
                        highlightedStatement={
                            interpreterState.highlightedStatement
                        }
                        highlightedExpression={
                            interpreterState.highlightedExpression
                        }
                    />
                    <ButtonControls
                        onFirst={handleFirst}
                ...
                <div className="flex flex-col w-[40vw] h-[85vh] gap-2">
                    <div className="h-2/3">
                        <VariablesWindow
                            ...
                            predictionVariable={
                                interpreterState.predictionVariable
                            }
                            predictionCorrectValue={
                                interpreterState.predictionCorrectValue
                            }
