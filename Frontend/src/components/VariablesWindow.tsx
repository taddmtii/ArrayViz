                    ...
                    <>
                        <div className="text-red-400 text-sm">
                            ...
                            <div className="text-xs mt-1">
                                Expected:{" "}
                                {formattedValue(
                                    predictionFeedback.correctValue,
                                )}
                            </div>
                        </div>
                    </>
                        ...
                        {objects.length === 0 ? (
                            ...
                            <div className="space-y-3">
                                {objects.map(({ id, value, type, name }) => {
                                    ...
                                    const objectVarName = Object.entries(
                                        references,
                                    ).find(
                                        ([name, objId]) => objId === id,
                                    )?.[0];
